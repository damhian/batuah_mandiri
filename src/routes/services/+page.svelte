...
<section class="bg-industrial-black pt-32 pb-20">
	<div class="container mx-auto px-4">
		...
		<p class="mt-8 text-lg text-white/40 uppercase tracking-[0.3em]">
			{$lang === 'en' ? 'Precision Engineering / Unstoppable Force' : 'Teknik Presisi / Kekuatan Tak Terbendung'}
		</p>
	</div>
</section>

<section class="py-24 bg-industrial-black min-h-[600px]" bind:this={container}>
	<div class="container mx-auto px-4">
		...
		{:else}
			<div class="grid gap-px bg-white/5 md:grid-cols-2 lg:grid-cols-2 border border-white/5">
				{#each data.services as item}
					<div class="fleet-card flex flex-col gap-12 bg-industrial-black p-12 transition-all hover:bg-industrial-slate/20 md:flex-row group border-white/5 overflow-hidden">
						<div class="aspect-video w-full overflow-hidden bg-industrial-slate md:aspect-square md:w-64 border border-white/5">
							{#if item?.image_url}
								<img 
...
<section class="border-t border-white/5 bg-industrial-black py-32">
	<div class="container mx-auto px-4">
		<div class="mx-auto max-w-4xl text-center">
			...
			<p class="mt-8 text-lg text-white/60 leading-relaxed italic border-l-4 border-industrial-yellow pl-8 text-left">
				{$lang === 'en' 
			...
			<div class="mt-12 flex justify-center gap-16 text-industrial-gold">
				<div class="flex flex-col items-center">
					<span class="block text-5xl font-black">99%</span>
					<span class="text-[10px] font-bold uppercase tracking-[0.3em] text-white/40 mt-2">
						{$lang === 'en' ? 'Uptime Standard' : 'Standar Uptime'}
					</span>
				</div>
				<div class="flex flex-col items-center">
					<span class="block text-5xl font-black">24/7</span>
					<span class="text-[10px] font-bold uppercase tracking-[0.3em] text-white/40 mt-2">
